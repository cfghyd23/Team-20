...
const Dashboard = ({ userData }) => {
  ...
  <div className="flex items-center justify-around" data-aos="fade-left" data-aos-offset="300"
    ...
    <div className="bg-orange-400 text-white p-4 rounded-lg w-4/12 h-2/3">
      ...
      <p className="mb-2 bg-orange-800 text-white p-4 rounded-lg h-2/3">State: Hi</p>
      <p className="mb-2 bg-orange-600 text-white p-4 rounded-lg h-2/3">Phone Number: Hi</p>
      <p className="mb-2 bg-orange-800 text-white p-4 rounded-lg h-2/3">: Hi</p>
    </div>
  ...
  <div className='bg-orange-400 mt-10 text-xl text-white p-4 py-10 rounded-lg w-11/12 mx-auto'>
    <div className='font-bold text-lg text-center'>www.zoom.us</div>
    <div className='font-bold text-lg text-center'>Mon-Fri 10:00 am - 11:00 am</div>
  </div>
</div>
  );
};
